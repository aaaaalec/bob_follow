...
from omni.isaac.examples.bob_follow_target import FollowTarget
...
class FollowTargetExtension(BaseSampleExtension):
    def on_startup(self, ext_id: str):
        ...
        super().start_extension(
            menu_name="",
            submenu_name="",
            name="Bob Follow Target",
            title="Bob Follow Target Task",
            ...
            overview="This Example shows how to follow a target using Bob robot in Isaac Sim.\n\nPress the 'Open in IDE' button to view the source code.",
            sample=FollowTarget(),
